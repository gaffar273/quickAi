    ...
    <div>
      <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
        ...
        <form onSubmit={onSubmitHandlar} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
          ...
          <textarea rows={4} onChange={(e) => setInput(e.target.value)} value={input} className='w-full p-2 mt-2 outline-none text-sm rounded-md border border-gray-300' placeholder='describe what you want to see in the image...' required />

          <p className='mt-4 test-sm font-medium'>Style</p>
          ...
          <div className='my-6 flex items-center gap-2'>
            <label className='relative cursor-pointer'>
              ...
              {/* Toggle track with the dot inside it */}
              <div className='w-9 h-5 bg-slate-300 rounded-full peer-checked:bg-green-500 transition relative'></div>
          ...
          <br />
          <button disabled={loading} className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#02d830] to-[#05a929] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
