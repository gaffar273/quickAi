    ...
    <div>
      <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
        ...
        <form onSubmit={onSubmitHandlar} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
          ...
          <p className='mt-6 text-sm font-medium'>Upload Upload Resume </p>

          <input onChange={(e) => setInput(e.target.files[0])} accept='application/pdf' type="file" className='w-full p-2 mt-2 outline-none text-sm rounded-md border border-gray-300 text-gray-600' required />


          <p className='mt-6 text-sm font-medium'>Supports PDF format only </p>
