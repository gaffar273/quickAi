...
const navItems = [
    ...
    { to: '/ai/comunity', label: 'Cominity', Icon: Users }
]
...
const Sidebar = ({ sidebar, setSidebar }) => {
    ...
    return (
        <div className={`w-60 bg-white border-r border-gray-200 flex flex-col justify-between items-center max-sm:absolutew top-14 bottom-0 ${sidebar ? 'translate-x-0' : 'max-sm:-translate-x-full'} transition-all duration-300 ease-in-out`}>
            <div className='my-7  w-full'>
                <img src={user.imageUrl} className='w-13 rounded-full mx-auto' alt="User avatar" />
                <h1 className='mt-1 mb-2 text-center'>{user.fullName}</h1>
                <div>
